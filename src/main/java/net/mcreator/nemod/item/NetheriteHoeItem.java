...
import net.mcreator.nemod.procedures.NetheriteHoeLivingEntityIsHitWithToolProcedure;
import net.mcreator.nemod.procedures.NetheriteHoeBlockDestroyedWithToolProcedure;
		...
		elements.items.add(() -> new HoeItem(new IItemTier() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					NetheriteHoeBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					NetheriteHoeLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
