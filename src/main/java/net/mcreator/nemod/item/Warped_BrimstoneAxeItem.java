...
import net.mcreator.nemod.procedures.WarpedBrimstoneAxeLivingEntityIsHitWithToolProcedure;
import net.mcreator.nemod.procedures.WarpedBrimstoneAxeBlockDestroyedWithToolProcedure;
		...
		elements.items.add(() -> new AxeItem(new IItemTier() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					WarpedBrimstoneAxeBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					WarpedBrimstoneAxeLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
