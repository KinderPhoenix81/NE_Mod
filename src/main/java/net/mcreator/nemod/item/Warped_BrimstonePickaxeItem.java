...
import net.mcreator.nemod.procedures.WarpedBrimstonePickaxeLivingEntityIsHitWithToolProcedure;
import net.mcreator.nemod.procedures.WarpedBrimstonePickaxeBlockDestroyedWithToolProcedure;
		...
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					WarpedBrimstonePickaxeBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					WarpedBrimstonePickaxeLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
