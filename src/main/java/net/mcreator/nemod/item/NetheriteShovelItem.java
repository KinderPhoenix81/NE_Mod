...
import net.mcreator.nemod.procedures.NetheriteShovelLivingEntityIsHitWithToolProcedure;
import net.mcreator.nemod.procedures.NetheriteShovelBlockDestroyedWithToolProcedure;
		...
		elements.items.add(() -> new ShovelItem(new IItemTier() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					NetheriteShovelBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					NetheriteShovelLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
