...
import net.mcreator.nemod.procedures.WarpedBrimstoneHoeLivingEntityIsHitWithToolProcedure;
import net.mcreator.nemod.procedures.WarpedBrimstoneHoeBlockDestroyedWithToolProcedure;
		...
		elements.items.add(() -> new HoeItem(new IItemTier() {
			...
			public boolean onBlockDestroyed(ItemStack itemstack, World world, BlockState bl, BlockPos pos, LivingEntity entity) {
				...
				int z = pos.getZ();
				{
					...
					WarpedBrimstoneHoeBlockDestroyedWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
			...
			public boolean hitEntity(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
				...
				World world = entity.world;
				{
					...
					WarpedBrimstoneHoeLivingEntityIsHitWithToolProcedure.executeProcedure($_dependencies);
				}
				return retval;
			}
