...
import net.mcreator.nemod.procedures.CrimsonBrimstoneBlockBlockDestroyedByPlayerProcedure;
import net.mcreator.nemod.procedures.CrimsonBrimstoneBlockBlockDestroyedByExplosionProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				CrimsonBrimstoneBlockBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				CrimsonBrimstoneBlockBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
