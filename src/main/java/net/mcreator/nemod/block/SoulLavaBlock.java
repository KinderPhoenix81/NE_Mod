...
public class SoulLavaBlock extends NeModModElements.ModElement {
	@ObjectHolder("ne_mod:soul_lava")
	public static final FlowingFluidBlock block = null;
	@ObjectHolder("ne_mod:soul_lava_bucket")
	public static final Item bucket = null;
	public static FlowingFluid flowing = null;
	public static FlowingFluid still = null;
	private ForgeFlowingFluid.Properties fluidproperties = null;
	public SoulLavaBlock(NeModModElements instance) {
		super(instance, 155);
	...
	public void initElements() {
		fluidproperties = new ForgeFlowingFluid.Properties(() -> still, () -> flowing,
				FluidAttributes.builder(new ResourceLocation("ne_mod:blocks/soul_lava_still"), new ResourceLocation("ne_mod:blocks/soul_lava_still"))
						.luminosity(15).density(1000).viscosity(1000)).bucket(() -> bucket).block(() -> block);
		still = (FlowingFluid) new ForgeFlowingFluid.Source(fluidproperties).setRegistryName("soul_lava");
		flowing = (FlowingFluid) new ForgeFlowingFluid.Flowing(fluidproperties).setRegistryName("soul_lava_flowing");
		elements.blocks.add(() -> new FlowingFluidBlock(still, Block.Properties.create(Material.LAVA)) {
		}.setRegistryName("soul_lava"));
		elements.items.add(() -> new BucketItem(still, new Item.Properties().containerItem(Items.BUCKET).maxStackSize(1).group(ItemGroup.MISC))
				.setRegistryName("soul_lava_bucket"));
	}
