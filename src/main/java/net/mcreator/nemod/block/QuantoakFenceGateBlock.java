...
public class QuantoakFenceGateBlock extends NeModModElements.ModElement {
	@ObjectHolder("ne_mod:quantoak_fence_gate")
	public static final Block block = null;
	public QuantoakFenceGateBlock(NeModModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("quantoak_fence_gate");
		}
