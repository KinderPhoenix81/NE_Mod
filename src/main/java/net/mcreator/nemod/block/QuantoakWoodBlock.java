...
public class QuantoakWoodBlock extends NeModModElements.ModElement {
	@ObjectHolder("ne_mod:quantoak_wood")
	public static final Block block = null;
	public QuantoakWoodBlock(NeModModElements instance) {
		super(instance, 1);
	}
