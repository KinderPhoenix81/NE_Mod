...
import net.mcreator.nemod.procedures.WarpedBrimstoneBlockBlockDestroyedByPlayerProcedure;
import net.mcreator.nemod.procedures.WarpedBrimstoneBlockBlockDestroyedByExplosionProcedure;
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState state, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, IFluidState fluid) {
			...
			int z = pos.getZ();
			{
				...
				WarpedBrimstoneBlockBlockDestroyedByPlayerProcedure.executeProcedure($_dependencies);
			}
			return retval;
		}
		...
		public void onExplosionDestroy(World world, BlockPos pos, Explosion e) {
			...
			int z = pos.getZ();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				WarpedBrimstoneBlockBlockDestroyedByExplosionProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
